...
<body>
  <header>
    <div class="logo">
    <a href="index.php"><b><h1 style="color:black; font-size:x-large">BOOKFLIX</h1></b>
    ...
    <div class="nav">
        ...
        <div class="dropdown">
            ...
            <a href="http://localhost/bookflix/index.php#New">New Arrives</a>
                <a href="http://localhost/bookflix/index.php#Adventure">Mythological</a>
                <a href="http://localhost/bookflix/index.php#Magical">Novels</a>
                <a href="http://localhost/bookflix/index.php#Stories">Stories</a>
                <a href="http://localhost/bookflix/index.php#Knowledge">History</a>
    ...
    <?php if(isset($_SESSION['user_name'])){echo' <img style="height:40px; margin-left:10px ;" src="images/user1.png" class="user-pic" onclick="toggleMenu()" />';}
      else{
