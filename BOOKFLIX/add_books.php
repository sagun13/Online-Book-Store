...
<a class="update_btn" style="position: fixed ; z-index:100;" href="total_books.php">See All Books</a>
  <div class="container_box">
    <form action="" method="POST" enctype="multipart/form-data">
      <h3>Add Books <a href="index.php"><span></span><span></span></a></h3>
      ...
      <select name="Category" id="" required class="text_field">
            <option value="Adventure">Mythological</option>
            <option value="Magic">Novels</option>
            <option value="Stories">Stories</option>
            <option value="knowledge">History</option>
         </select>
