...
<body>
    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item active">
            <img class="d-block w-100" src="Books Picture/slide4.jpg" alt="First slide" style="width: 80%; height: auto; max-height: 400px; object-fit: cover; margin: 10px auto; border-radius: 15px;">
        </div>

        <!-- Second Slide -->
        <div class="carousel-item">
            <img class="d-block w-100" src="Books Picture/slide2.jpg" alt="Second slide" style="width: 80%; height: auto; max-height: 400px; object-fit: cover; margin: 20px auto; border-radius: 15px;">
        </div>

        <!-- Third Slide -->
        <div class="carousel-item">
            <img class="d-block w-100" src="Books Picture/slide3.jpg" alt="Third slide" style="width: 80%; height: auto; max-height: 400px; object-fit: cover; margin: 20px auto; border-radius: 15px;">
        </div>
    </div>
        ...
        <!-- Second Slide -->
        <div class="carousel-item">
            <img class="d-block w-100" src="Books Picture/slide2.jpg" alt="Second slide" style="width: 80%; height: auto; max-height: 400px; object-fit: cover; margin: 20px auto;">
        </div>

        <!-- Third Slide -->
        <div class="carousel-item">
            <img class="d-block w-100" src="Books Picture/slide3.jpg" alt="Third slide" style="width: 80%; height: auto; max-height: 400px; object-fit: cover; margin: 20px auto;">
        </div>
    </div>
    ...
    <section id="New">
        ...
        <center><h2 class="m-8 font-extrabold text-4xl text-center border-t-2 " style="color: rgb(0, 167, 245);">
                New Arrival
            </h2></center>
        </div>
    </section>
    ...
    <section class="show-products">
        <div class="box-container">
            ...
            <?php
            $select_book = mysqli_query($conn, "SELECT * FROM `book_info` where category='Stories'") or die('query failed');
            if (mysqli_num_rows($select_book) > 0) {
                while ($fetch_book = mysqli_fetch_assoc($select_book)) {
            ?>
    ...
    <section id="Knowledge">
        ...
        <div class="container px-5 mx-auto">
        <center><h2 class="text-gray-400 m-8 font-extrabold text-4xl text-center border-t-2 text-red-800" style="color: rgb(0, 167, 245);">
                History
            </h2></center>
        </div>
    </section>
